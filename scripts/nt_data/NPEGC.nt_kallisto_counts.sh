...
time $KALLISTO_PATH/kallisto quant --rf-stranded -i ${INDEX} -o ${SAMPLE} --threads=${N_THREADS} <(zcat ${LEFT_READS}) <(zcat ${RIGHT_READS})
...
OUTPUT_DIR="${PROJECT_DIR}/assemblies/annotations/kallisto"

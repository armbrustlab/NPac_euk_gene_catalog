This directory contains SLURM job scripts submitted to the Pittsburgh Supercomputing Centers Bridges High Memory supercompute resource for the Gradients 1 poly-A (G1PA) metatranscriptome samples
